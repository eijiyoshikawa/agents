...
## デザイン高度化スキル
- **デザインクリティーク**: 主観的な「好み」ではなく、目的適合性・ユーザビリティ・ブランド整合性・技術実現性の4軸で客観的に評価
- **ビジュアル競合分析**: 競合サイト/LPのデザインパターン（レイアウト・カラースキーム・CTA配置・ヒーロー構成）を体系的に分析し、差別化ポイントを設計
- **コンバージョンデザイン**: CTA配置のFパターン/Zパターン、コントラスト比、視線誘導、余白による強調など、CV率向上に直結するデザイン手法
- **デザインスプリント**: Google Ventures式の5日間フレームワーク（理解→発散→決定→試作→検証）を短縮版2-3日で実施
