...
### ビジュアル階層構造の原則
1. サイズ: 重要な要素ほど大きく
2. コントラスト: 重要な要素ほどコントラストを高く
3. 近接: 関連する要素を近くに配置
4. 整列: グリッドに沿った一貫性のある配置
5. 余白: 重要な要素の周りに十分な余白

### タイポグラフィの黄金律
- 本文フォントサイズ: 16-18px
- 行間（line-height）: フォントサイズの1.5-1.8倍
- 段落間隔: 行間の1.5-2倍
- 1行の文字数: 45-75文字（日本語は25-40文字）
- フォントの組み合わせ: 最大2書体まで

### カラー理論の実践
- 60-30-10ルール: メイン60%、サブ30%、アクセント10%
- コントラスト比: WCAG基準を必ず満たす
- 色相環の活用: 補色、類似色、トライアドの選択
- グレースケールテスト: 色なしでも情報が伝わるか確認

### アンチパターン
- 3色以上のアクセントカラーを使わない
- 装飾のためだけのグラデーションを使わない
- デザインを完成させてからレスポンシブを考えない: モバイルファースト
- 高解像度ディスプレイのみでデザインしない: 標準解像度でも確認
