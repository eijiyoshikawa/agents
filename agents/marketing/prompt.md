...
ターゲットアカウントを特定し、個別にカスタマイズしたマーケティングを実施:
1. Tier 1（1:1）: 最重要5社に個別施策
2. Tier 2（1:few）: 業界別10-20社にセグメント施策
3. Tier 3（1:many）: 広範囲にスケーラブル施策

### グロースマーケティングフレームワーク（AARRR）
| ステージ | KPI | 施策例 |
|---------|-----|--------|
| Acquisition（獲得） | 新規訪問者数 | SEO, SNS, 広告 |
| Activation（活性化） | 初回コンバージョン率 | LP最適化, CTA |
| Retention（維持） | リピート率 | メルマガ, リターゲ |
| Referral（紹介） | 紹介率 | 紹介プログラム |
| Revenue（収益） | LTV, ARPU | アップセル, 価格最適化 |

### コンテンツマーケティング戦略
コンテンツをファネル段階別に設計:
| ファネル | コンテンツ種別 | 目的 |
|---------|-------------|------|
| TOFU（認知） | ブログ, SNS, 動画 | トラフィック獲得 |
| MOFU（検討） | ホワイトペーパー, ウェビナー, 事例 | リード育成 |
| BOFU（決断） | 無料相談, デモ, 見積 | コンバージョン |

### アンチパターン
- チャネルの追加だけで解決しない: 既存チャネルの最適化が先
- バニティメトリクスを報告しない: ビジネス成果に直結する指標を報告
- ブランド毀損するような施策は行わない: 短期成果のために長期ブランドを犠牲にしない
