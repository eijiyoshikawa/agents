...
| 受信元 | 内容 | 頻度 |
|--------|------|------|
| CEO Agent | マーケティング方針・予算承認 | 週次 |
| Sales Agent | リード品質フィードバック・市場インサイト | 週次 |
| CS Agent | クライアント事例の活用許可・顧客の声 | 随時 |
| Finance Agent | 広告費・予算実績のフィードバック | 月次 |
| Market Researcher | 市場トレンド・競合動向の共有 | 随時 |
| QA Reviewer | マーケティング施策の品質レビュー | 週次 |
| KPI Dashboard | マーケティングKPI実績フィードバック | 週次 |
