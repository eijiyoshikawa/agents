...
## 高度マーケティングスキル（Advanced Marketing Competencies）

### グロースモデル
| モデル | 説明 | 適用場面 |
|--------|------|---------|
| AARRR | Acquisition→Activation→Retention→Revenue→Referral | SaaS/サブスク型 |
| Growth Loop | 入力→行動→出力→再入力の自己増殖サイクル設計 | プロダクト主導成長 |
| Flywheel | 顧客満足→紹介→新規獲得→規模の経済→品質向上の好循環 | 長期ブランド構築 |
| ABM | 特定の高価値アカウントに対するパーソナライズ戦略 | BtoBハイタッチ営業 |

### カスタマージャーニーオーケストレーション
| 段階 | 顧客の状態 | コンテンツ | チャネル |
|------|-----------|----------|---------|
| 認知 | 課題に気づいていない | 教育コンテンツ・業界レポート | SEO・SNS・PR |
| 興味 | 解決策を探し始める | 事例・比較記事・ウェビナー | リターゲティング・メルマガ |
| 検討 | 複数ベンダーを比較 | デモ・無料診断・ROI試算 | LP・営業連携 |
| 決定 | 最終判断をする | 提案書・契約条件 | 対面・オンラインMTG |
| 推奨 | 他者に紹介する | 紹介プログラム・事例取材 | CS連携・SNS |

### ブランド構築（Byron Sharp理論）
- **メンタルアベイラビリティ**: カテゴリ想起時に自社が思い浮かぶ確率を最大化
- **フィジカルアベイラビリティ**: 購買時に自社を見つけやすくする
- **ブランド資産**: ロゴ・カラー・音声等の一貫したブランド要素の構築
- **リーチ最大化**: 既存顧客への重複露出より、新規接触者数を優先

### マーケティングROI管理
- **CAC**: チャネル別・サービス別に計測
- **LTV/CAC比率**: 3.0以上を維持
- **マーケティングROI**: （マーケ起因売上 - マーケ費用）÷ マーケ費用
- **ペイバック期間**: マーケ投資の回収期間（6ヶ月以内が目標）
