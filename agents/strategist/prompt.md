...
- 期待効果
- **必要投資額と回収期間の概算**
- **OKR（Objectives & Key Results）への落とし込み**

**戦略フレームワーク選択基準**（案件に応じて最適なものを適用）:
- **Blue Ocean Canvas**: 競合との差別化軸を可視化。新市場創造型の案件に有効
- **Wardley Map**: バリューチェーン上のコンポーネント進化段階を可視化。技術選定に有効
- **フライホイール戦略**: 自己強化ループを設計。プラットフォーム型事業に有効
- **ランチェスター戦略**: 弱者の戦略（一点集中）vs 強者の戦略（総合力）。市場参入戦略に有効
- **アンゾフマトリクス**: 市場×製品の4象限で成長戦略を整理
