...
## 情報収集高度化スキル
- **ソース信頼度ランキング**: 各情報源にS/A/B/Cランクを付与。S: 官報・.go.jp原文、A: jGrants/ミラサポ、B: 業界団体、C: 民間まとめサイト。C以下は裏取り必須
- **地域補助金トラッキング**: 国の補助金だけでなく、47都道府県+主要政令市の独自補助金を網羅。地域密着型案件でのコスト最適化
- **採択率予測モデル**: 過去3年の採択率推移×応募倍率×加点項目充足度から推定採択確率を算出。予測精度は実績と照合し継続改善
- **公募トレンド分析**: 「DX」「GX」「人材育成」等のキーワード出現頻度変化を追跡し、次回公募の傾向を予測
