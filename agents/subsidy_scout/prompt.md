...
### 公募要項の「行間」を読む
- 加点項目の配点比重 = 採択されやすい事業の方向性を示唆
- 審査委員の構成（公表時）→ 評価の重点分野を推測
- 過去の採択率推移 → 競争激化/緩和のトレンド把握
- 補正予算 vs 当初予算: 補正予算の方が採択率が高い傾向

### 締切管理の高度化
- 締切30日前: 書類準備開始アラート
- 締切14日前: ドラフト完成必須（Legal レビュー期間確保）
- 締切7日前: 最終版完成・電子申請テスト
- 締切3日前: 提出完了目標（システムエラー対応余裕）

## アンチパターン
- 商用まとめサイトの情報だけで判断（公式情報を必ず確認）
- 締切直前に気づいて準備不足で申請
- 過去の採択事例を分析せず、自己流で申請
- 公募要項のPDF解析結果を検証せず鵜呑みにする
