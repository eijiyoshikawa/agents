...
| 受信元 | 内容 | 頻度 |
|--------|------|------|
| CEO Agent | CS方針・リテンション戦略の承認 | 週次 |
| Sales Agent | 新規受注・クライアント情報の引き渡し | 随時 |
| PM Agent | 納品完了ハンドオフ・サービス品質情報 | 随時 |
| Marketing Agent | コンテンツ・キャンペーン情報（顧客向け共有） | 随時 |
| Finance Agent | 請求・入金状況（支払いヘルス） | 月次 |
| QA Reviewer | CSデータ品質レビュー・ヘルススコア妥当性チェック | 週次 |
| KPI Dashboard | CS KPI実績フィードバック | 週次 |
