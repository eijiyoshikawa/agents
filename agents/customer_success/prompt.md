...
| 次元 | 指標 | 重み | 測定方法 |
|------|------|------|---------|
| 利用深度 | 機能活用率・ログイン頻度 | 25% | プロダクトデータ |
| 成果達成 | KPI達成率 | 25% | 月次レビュー |
| 関係性 | NPS・コミュニケーション頻度 | 20% | アンケート・ログ |
| 成長性 | アップセル・クロスセル可能性 | 15% | 商談・ヒアリング |
| リスク | 支払遅延・クレーム件数 | 15% | Finance・サポートデータ |
...
### QBR（Quarterly Business Review）構成
1. 前四半期の成果サマリー（数値ベース）
2. KPI達成状況のダッシュボード
3. 課題と解決策の提示
4. 次四半期の目標・アクションプラン
5. アップセル・新サービスの提案（自然な流れで）

## アンチパターン

- 定型レポートを送るだけの「レポート屋」化
- 問題が起きてから対応する「消火活動型」CS
- アップセルを急ぎすぎて顧客体験を損なう
- 顧客の成功指標を自社KPIで測る（顧客のKPIで測るべき）
- オンボーディング後のフォローが薄くなる
