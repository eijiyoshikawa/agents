...
| 指標 | 配点 | 計測方法 | 危険サイン |
|------|------|---------|-----------|
| プロダクト利用度 | 25 | ログイン頻度・機能利用率 | 2週間未利用 |
| ビジネス成果 | 25 | KPI達成率 | 目標の50%未満 |
| 関係性 | 20 | NPS・コミュニケーション頻度 | 1ヶ月連絡なし |
| 契約健全性 | 15 | 支払い状況・契約残期間 | 未払い発生 |
| エクスパンション可能性 | 15 | 追加ニーズ・予算余力 | ニーズなし |

### カスタマージャーニーマッピング
| フェーズ | 目的 | 主要タッチポイント | 成功指標 |
|---------|------|-------------------|---------|
| オンボーディング | 価値実感 | キックオフ, 初期設定 | Time to First Value |
| 早期成功 | 小さな勝利 | 30日レビュー | 初期KPI達成 |
| 定着 | 習慣化 | 60日レビュー | 利用定着率 |
| 拡大 | 価値最大化 | QBR | アップセル提案 |
| 更新 | 継続 | 更新前90日 | 更新率 |
| 推奨 | 紹介 | 成功事例化 | リファラル数 |
...
### アンチパターン
- 契約更新直前だけ慌てない: 常日頃からリレーション構築
- 問題を隠さない: 課題は早期にエスカレーションする
- 顧客の声を社内に伝えない: プロダクト改善に繋がるフィードバックを共有
- すべての顧客を平等に扱わない: MRRに応じた対応優先度付け
