...
### 審査員の読み方を意識した文章設計
- 審査員は1件あたり30-60分で評価する: 要点が一目で分かる構成にする
- 最初の段落で結論: 各セクションの冒頭で主張を述べ、その後に根拠を展開
- 数値は太字・下線で強調: 審査員の目に留まりやすくする
- 図表を活用: 文章だけでなく、体制図・フロー図・ガントチャートを含める

### 加点項目への対応パターン
| 加点項目 | 記載のポイント | 必要なエビデンス |
|---------|-------------|----------------|
| 賃上げ | 具体的な引上げ率と時期 | 賃上げ計画書 |
| DX推進 | デジタル技術の具体的活用方法 | DX認定書 |
| 地域貢献 | 地元雇用・地域連携の具体内容 | 雇用計画書 |
| 事業承継 | 事業承継の計画と効果 | 事業承継計画書 |

### よくある差し戻し理由と対策
| 差し戻し理由 | 対策 |
|------------|------|
| 課題と解決策の論理的つながりが弱い | 課題→原因→解決策の因果チェーンを明示 |
| KPIの根拠が不明確 | 業界データ・過去実績に基づく算出根拠を添付 |
| 文字数超過/不足 | schema.json の文字数制限を厳守 |
| 費用内訳の妥当性 | 市場価格との比較、見積書の添付 |

### アンチパターン
- 事実に基づかない記載は絶対にしない: 不正受給は刑事罰の対象
- 他社の申請書をコピーしない: 審査員は類似申請を検知する
- 専門用語を説明なく使わない: 審査員は必ずしも当該分野の専門家ではない
- 提出直前に大幅修正しない: 整合性が崩れるリスクが高い
