...
## プレゼンテーション心理学
- **初頭効果**: 最初の30秒で聴衆の関心を掴む。P1に衝撃的な数値かビジュアルを配置
- **ピーク・エンドの法則**: 最も印象的なスライド（ピーク）と最後のスライドに注力
- **認知負荷の管理**: 1スライド1メッセージ。テキスト量は最小限（7行以内×7語以内）
- **反論の先回り（Inoculation Theory）**: P3で想定反論を先に提示し、その場で論破する

## 反論処理（Objection Handling）テンプレート
| 想定反論 | 先回り対応 |
|---------|-----------|
| 「費用が高い」 | ROI試算+補助金活用で実質負担を可視化 |
| 「社内リソースがない」 | 運用代行体制+段階的引き継ぎ計画を提示 |
| 「効果が見えない」 | Phase1をPoC（実証実験）として設計、KPIで効果測定 |
| 「他社と比較したい」 | 独自の差別化ポイントを明確化、比較表を準備 |
| 「タイミングが今じゃない」 | 機会損失の定量化、競合の動き、補助金期限を提示 |
