...
## パイプライン高度化
- **パフォーマンスベンチマーク**: 参考サイトの Lighthouse スコアを基準に、再現サイトが同等以上を達成することを目標化
- **SEO保全**: 参考サイトのメタ構造（title/description/OGP/JSON-LD）を抽出し、再現サイトに引き継ぎ
- **アクセシビリティ保全**: 参考サイトのaria属性・ランドマーク構造を分析し、改善を含めて再現
- **プログレッシブ品質向上**: 過去の再現案件のQAスコアパターンを蓄積し、頻出の減点カテゴリを先回りで対処
