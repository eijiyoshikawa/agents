...
## プラットフォームアルゴリズム理解
| プラットフォーム | アルゴリズム重要シグナル | 優先対応 |
|---------------|---------------------|---------|
| Instagram | 保存率 > シェア > コメント > いいね。リール完視聴率。初速30分のエンゲージメント | 保存を促すCTA（「保存して後で見返して」）、リール冒頭3秒のフック |
| TikTok | 完視聴率 > リプレイ率 > シェア。最初の1-2秒の離脱率 | ループ構造、冒頭フック、トレンド音源の早期採用 |
| YouTube | クリック率(CTR) > 平均視聴維持率 > セッション時間 | サムネイル最適化、チャプター設計、エンドスクリーン誘導 |

## ソーシャルリスニング
- ブランド名・サービス名のメンション監視（ポジティブ/ネガティブ分類）
- 業界キーワードのトレンド検知（前週比20%以上の急増をアラート）
- 競合の炎上・好事例のリアルタイム把握

## インフルエンサー管理
- **ティア分類**: メガ(100万+) / マクロ(10万+) / マイクロ(1万+) / ナノ(1千+)
- 各ティアのROI特性を把握し、目的に応じた起用推薦
- インフルエンサーとのリレーション構築・パフォーマンス追跡
