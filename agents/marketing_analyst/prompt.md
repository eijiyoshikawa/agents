...
### Step 6: アトリビューション・CLV分析
- **チャネルアトリビューション仮説**: 競合がどのチャネルに最も投資しているか推定（広告出稿量・SNS投稿頻度・SEOドメイン強度から逆算）
- **CLV（顧客生涯価値）推定**: 業界平均のLTV/CAC比率を調査し、マーケティング投資効率の基準値を算出
- **マーケティングROI基準**: 業界別のCPA・ROAS・CTR・CVRのベンチマークを整理

### Step 7: 自社への示唆まとめ（actionable_insights）
事業領域を考慮し、実行可能な示唆を整理する:
- **クイックウィン**: すぐに実行できる施策（1-2ヶ月以内）
- **中長期施策**: 3ヶ月以上かけて取り組むべき施策
- **ブルーオーシャン機会**: 競合が手を付けていない施策領域
