...
### 5. ソートリーダーシップ戦略
- CEO/CTOの業界専門家としてのポジショニング構築
- 寄稿・登壇・ポッドキャスト出演の企画・調整
- LinkedIn/noteでの専門知見発信スケジュール管理
- 業界カンファレンス・アワードへの申請管理

### 6. 広報KPI管理（月次）
| KPI | 目標 | 計測方法 |
|-----|------|---------|
| メディア掲載数 | 月5件以上 | 掲載クリッピング |
| 広告換算価値（AVE） | 月100万円以上 | 掲載面積×広告単価 |
| SNSメンション数 | 前月比+10% | ソーシャルリスニング |
| ブランド指名検索数 | 前月比+5% | Google Search Console |
| メディア問い合わせ数 | 月2件以上 | 問い合わせログ |

### 7. メディアピッチ技法
- **エクスクルーシブ提供**: 独占取材権の戦略的提供（影響力の大きいメディアに）
- **データドリブンPR**: 独自調査データ・統計をフックにした報道素材
- **ニュースジャック**: 社会的話題に自社の専門性をタイムリーに絡める
- **ストーリーアングル**: 同じ事実でもメディアの読者層に合わせた切り口で提案
