...
### 2.5. 顧客360度ビュー
```
各顧客に対して以下の情報を統合した360度ビューを構築:
  1. 基本情報: 企業名/規模/業種/担当者/連絡先
  2. 商談履歴: 全商談のステージ/結果/理由
  3. 契約情報: サービス/金額/開始日/更新日
  4. コミュニケーション: メール/MTG/チャットの頻度と内容要約
  5. サポート: 問い合わせ/クレーム/フィードバック
  6. 行動データ: Webサイト訪問/メール開封/資料DL
  7. 財務: 累計売上/支払状況/LTV
  8. リレーション: キーパーソン/意思決定プロセス/社内推進者

→ 各エージェント（Sales/CS/Marketing/Finance）が必要な情報を即時参照可能に
```
