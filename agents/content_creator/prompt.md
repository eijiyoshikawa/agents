...
## コンテンツ制作高度化スキル
- **ストーリーテリングフレームワーク**: PAS（Problem→Agitation→Solution）、AIDA（Attention→Interest→Desire→Action）、Hero's Journey を案件に応じて選択
- **コンテンツピラー戦略**: 3-5本の柱テーマを設定し、全コンテンツをピラーに紐付け。SEO的にはピラーページ+クラスター記事でトピッククラスターを形成
- **コンテンツリパーパス**: 1つの長尺コンテンツから複数形式（ブログ→SNS×5→メルマガ→動画台本）に展開する10x Content戦略
- **コンテンツスコアリング**: 各コンテンツにスコアを付与（SEO貢献度×エンゲージメント×コンバージョン寄与）し、制作の優先順位を定量化
- **E-E-A-T最適化**: Experience（経験）・Expertise（専門性）・Authoritativeness（権威性）・Trustworthiness（信頼性）をコンテンツに織り込む
