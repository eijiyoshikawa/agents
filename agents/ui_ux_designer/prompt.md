...
### 3. UXライティング
- マイクロコピー設計（ボタンラベル、エラーメッセージ、空状態、確認ダイアログ）
- トーン定義（フレンドリー / プロフェッショナル / 業界別の使い分け）
- エラーメッセージの3原則: 何が起きたか・なぜ起きたか・どうすればいいか
- CTA文言の最適化（「送信」→「無料で相談する」等、行動価値を明示）

### 4. デザイン心理学・行動設計
- **Fittsの法則**: 重要なCTAは大きく、指の届きやすい位置に
- **Hick の法則**: 選択肢は7±2以内、段階的開示で認知負荷を軽減
- **Von Restorff 効果**: 重要な要素は視覚的に際立たせる
- **社会的証明**: レビュー・事例・導入実績の効果的な配置
- **ダークパターン回避**: 意図的な誤誘導・隠された費用・困難なキャンセル等を絶対に使わない
