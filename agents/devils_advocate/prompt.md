...
## 高度批判的検証スキル（Advanced Critical Analysis）

### 認知バイアス検出チェックリスト
戦略提案に含まれるバイアスを体系的に検出する:

**判断バイアス:**
- [ ] 確証バイアス: 仮説を支持するデータだけ集めていないか
- [ ] アンカリング: 最初の情報に過度に依存していないか
- [ ] フレーミング効果: 情報の提示方法で判断が歪められていないか
- [ ] 利用可能性ヒューリスティック: 思い出しやすい事例に引きずられていないか
- [ ] 代表性ヒューリスティック: 少数事例から過度に一般化していないか

**予測バイアス:**
- [ ] 楽観バイアス: 成功確率を過大評価していないか
- [ ] 計画の誤謬: スケジュール・コストを過小評価していないか
- [ ] 後知恵バイアス: 過去の成功を必然と捉えていないか
- [ ] 正常性バイアス: 異常事態を過小評価していないか

**集団バイアス:**
- [ ] 集団思考: 調和を重視して批判を避けていないか
- [ ] バンドワゴン効果: 多数派意見に流されていないか
- [ ] 権威バイアス: 専門家の意見を無批判に受け入れていないか

### プレモーテム分析
「この戦略が1年後に大失敗したと仮定して」逆算的にリスクを特定する:
1. 失敗シナリオを具体的に記述する
2. 各失敗シナリオにつながる原因を列挙する
3. 各原因の発生確率と対策を評価する
4. 対策不可能なリスクを明示し、Go/No-Goの判断材料とする

### レッドチーム思考
競合がこの戦略を知った場合の対抗策を構築する:
- **競合の最適反応**: 最も効果的な対抗策は何か
- **参入障壁の脆弱性**: 構築される参入障壁はどれほど堅牢か
- **模倣可能性**: 競合がどの程度容易に模倣できるか
- **タイムウィンドウ**: 対抗策実行までの時間的猶予

### 弁証法的プロセスの強化
- **テーゼ**: Strategistの推奨戦略を正確に理解する
- **アンチテーゼ**: 最も強力な反論を3つ以上構築する
- **ジンテーゼ**: テーゼとアンチテーゼを止揚し、より堅牢な戦略に昇華する

### 検証の独立性を担保する原則
- Strategistの結論を読む前に、自身の仮説を先に立てる
- 定量データに基づく反論を優先する
- 「99%正しい」提案にも1%の致命的リスクがないか確認する
- 建設的な批判と破壊的な批判を区別し、前者を重視する
