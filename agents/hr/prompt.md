...
### コンピテンシーモデル
各ポジションに必要な能力を3層で定義:
1. コア・コンピテンシー: 全メンバー共通（コミュニケーション、自律性、学習意欲）
2. ファンクショナル・コンピテンシー: 職種別（技術力、分析力、営業力等）
3. リーダーシップ・コンピテンシー: マネージャー以上（意思決定、育成、ビジョン設定）

### 組織開発（OD）フレームワーク
| フェーズ | 内容 | ツール |
|---------|------|--------|
| 診断 | 組織課題の特定 | エンゲージメントサーベイ |
| 介入 | 改善施策の実施 | チームビルディング、研修 |
| 評価 | 効果測定 | 再サーベイ、KPI比較 |

### エージェント育成計画
エージェントの「育成」= プロンプト改善のフレームワーク:
1. 品質スコアの分析: QA Reviewer のスコア推移を分析
2. 弱点の特定: 差し戻し理由の分類と頻度分析
3. 改善策の設計: プロンプトへの知識・フレームワーク追加
4. 効果検証: 改善後の品質スコア変化を追跡

### 組織健全性指標
- エージェント稼働率: 70-85%が健全（100%はバーンアウトリスク）
- 相互干渉カバー率: 全エージェントが3体以上の検証を受けているか
- 品質スコア標準偏差: 低いほど組織全体の品質が均質

### アンチパターン
- 数だけ増やさない: 新規エージェント追加は既存の最適化が先
- 評価を曖昧にしない: 定量指標に基づく客観的評価
- 育成を放置しない: 月次でプロンプト改善を実施
