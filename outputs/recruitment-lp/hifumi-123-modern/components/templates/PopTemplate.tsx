  ...
  return (
    <main className="min-h-screen bg-construction-400 text-stone-900">
      ...
      <section className="relative overflow-hidden px-5 py-16 sm:px-6 sm:py-20 md:py-28">
        <div className="pointer-events-none absolute left-6 top-10 hidden h-24 w-24 border-8 border-stone-900 lg:block" />
        <div className="pointer-events-none absolute right-8 bottom-6 hidden h-16 w-16 rotate-45 bg-safety-500 lg:block" />
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <h1 className="font-sans text-3xl font-black leading-[1.45] tracking-tight sm:text-4xl md:text-6xl md:leading-[1.4]">
            <span className="bg-stone-900 box-decoration-clone px-3 py-2 text-construction-400 sm:px-4 sm:py-2 md:py-3">
